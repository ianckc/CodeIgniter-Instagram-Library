...
class Instagram_api {
     ...
     * @return array data returned form curl call
     */
     ...
     * @return array Instagram OAuth data
     */
     ...
     * @return array current popular media with associated data
     */
     ...
     * @return array data about the Instagram user
     */
     ...
     * @return array of media found based on parameters given
     */
     ...
     * Accepts a user id
     * @param int user id
     * @return array user's recent feed items
     */
     ...
     * Accepts a user id
     * @param int user id
     * @return array other users that follow the one passed in
     */
     ...
     * @return array users who have requested this user's permission to follow
     */
     ...
     * @param int user id
     * @return array user's relationship to another user
     */
     ...
     * Accepts a media id
     * @param int media id
     * @return array data about the media item
     */
     ...
     * @param int distance
     * @return array media items found in search
     */
     ...
     * @return array response to request
     */
     ...
     * @param string tag
     * @return array of data about the tag
     */
     ...
     * @return array recently tagged media
     */
     ...
     * @return array tags by name - results are ordered first as an exact match, then by popularity
     */
     ...
     * @return array data about the location
     */
     ...
     * @param int return media after this UNIX timestamp
     * @param int return media before this UNIX timestamp
     * @return array recent media objects from a location
     */
